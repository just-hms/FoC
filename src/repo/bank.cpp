...
namespace repo {
    ...
    BankRepo::BankRepo(std::string folder_path, std::string secret, int historyLen){
    ...
    std::tuple<entity::User, entity::Error> BankRepo::getUserByName(std::string username){
        auto filename = this->folder_path + "users.json";
    ...
    std::tuple<std::shared_ptr<entity::User>, entity::Error> BankRepo::Login(std::string username, std::string password){
    ...
    std::tuple<entity::Balance, entity::Error> BankRepo::Balance(std::string username){
        auto [us, err] = this->getUserByName(username);
        if(err != entity::ERR_OK) {
    ...
    entity::Error BankRepo::updateHistory(std::string username, entity::History * h){
    ...
    std::tuple<entity::History, entity::Error> BankRepo::History(std::string username){
