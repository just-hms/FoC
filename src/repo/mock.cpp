...
namespace repo {
    ...
    std::tuple<std::shared_ptr<entity::User>, entity::Error> MockBankRepo::Login(std::string username, std::string password){
    ...
    std::tuple<entity::Balance, entity::Error> MockBankRepo::Balance(std::string USER_ID){
    ...
    std::tuple<entity::History, entity::Error> MockBankRepo::History(std::string username){
